...
export const DragCards = () => {
  ...
  return (
    ...
    animate={{opacity:1, scale:1}}
     className=" relative w-full h-[300vh] flex justify-center items-center ">
      <section className="sticky flex items-center justify-center min-h-screen w-1/2  place-content-center overflow-hidden bg-neutral-950">
      <h2 className="relative z-0 text-[10vw] font-black text-neutral-800 md:text-[200px]">
        THINGS I LOVE<span className="text-indigo-500">.</span>
      </h2>
      <Cards />
    </section>
    </motion.div>
...
//@ts-ignoreconst {scrollYProgress} = useScroll
